...
contract Content is Ownable {
    ...
    event RunFinalize(uint256 requestID, bool result);
    event RunStatusChange(int proposedStatusCode, int returnStatusCode, int256 licenseFeeToBePaid);
    ...
    // Other number can be used as error codes and would stop the processing.
    function runAccess(
        uint256, /*request_ID*/
        uint8, /*level*/

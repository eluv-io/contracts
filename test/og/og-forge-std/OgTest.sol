...
contract OgTest is DSTest, OgScript {
    ...
    function bound(uint256 x, uint256 min, uint256 max) internal returns (uint256 result) {
...
bytes32 _set;
    ...
    OgVm private constant vm_std_store = OgVm(address(uint160(uint256(keccak256('hevm cheat code')))));
